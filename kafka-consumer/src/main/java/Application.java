...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        Consumer<Long, String> kafkaConsumer = createConsumers(BOOTSTRAP_SERVERS, consumerGroup);
        ...
        while(true) {
            ...
            if(consumerRecords.isEmpty()) {
                ...
                for(ConsumerRecord record : consumerRecords) {
                    System.out.println(String.format("Received message (key: %d, value: %s) , partition %d offset %d",
    ...
    public static Consumer<Long, String> createConsumers (String bootstrapServers, String consumerGroup) {
